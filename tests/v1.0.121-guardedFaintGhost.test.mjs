...
test('guarded micro-override cleans faint residue beside high-contrast text while preserving the text stroke', () => {
  ...
  const result = applyGuardedFaintGhostDissolve(image, alpha, {
    ...
    minConsensus: 0,
    minDonorPairAgreement: 0,
    guardedMinConsensus: 0,
    guardedMinAgreement: 0,
    guardedMinCoverage: 0,
    guardedMaxSpread: 255,
    guardedMaxResidual: 18,
    guardedMaxAlpha: 1,
    guardedMaxGradient: 255,
    guardedMaxContinuity: 1.01,
    residualSoft: 0.01,
    residualHard: 0.20,
    samplesPerSide: 1,
    maxAnchorSafetyWeight: 1
